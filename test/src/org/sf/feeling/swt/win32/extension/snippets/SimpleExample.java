...
public class SimpleExample {
	...
	public SimpleExample() {
		...
		shell.setText("SWT Extension Example");
		...
		label = createLabel();
		label.setText("Memory Total:		" + memoryStatus.dwTotalPhys / (1024)
				+ " KB");

		label = createLabel();
		label.setText("Memory Available:	" + memoryStatus.dwAvailPhys / (1024)
				+ " KB");
